...
function randomForest_classification_model(FeatureCollection, bandList, image, label, parameters) {
...
function randomForest_regression_model(FeatureCollection, bandList, image, label, string, parameters) {
